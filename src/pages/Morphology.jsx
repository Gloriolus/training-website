    ...
    <main className="container px-4 py-4">
      <article>
        <section>
          ...
          <p>Коала — невелика тварина зі збитим тілом.</p>
        </section>
        <section>
        ...
        <figure className="text-center">
          <img src="/images/everyday-carry-flickr-3bsjpg.webp" alt="Коала в лісі" className="img-fluid rounded my-4"/>
          <figcaption className="text-muted">Коала в лісі</figcaption>
        </figure>
      </article>
    </main>
  );
